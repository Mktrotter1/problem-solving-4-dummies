...
You did the thing. Now compare reality against your definition of done from step 5.

## What This Step Is

Checking means objectively evaluating whether your action actually solved the problem. Not whether you *feel* like it's solved. Not whether the action *should have* worked. Whether it *did* work.

This is where your definition of done pays off. Without it, this step degenerates into vibes.
...
- **Declaring victory too early.** Check thoroughly. The problem that "went away" often just went dormant.
- **Skipping this step.** "I did the thing, so it must be fixed." This is how problems recur.
- **Confirmation bias.** You want it to be fixed. That want will make you see success where there isn't any. Be honest.
- **Not checking for side effects.** Solving one problem while creating two others is a net loss.

## The Key Question

**"Does reality now match my definition of done from step 5?"**

If yes, move to [Step 10: Reflect](../10-reflect/).
If no, go back to the appropriate earlier step with your new information.
